...
#include "lib/edadb/impl/DbBackend.hpp"
#include "lib/edadb/impl/DbLogger.hpp"
#include "lib/edadb/impl/SimpleOID.hpp"
#include "lib/edadb/impl/CppTypeToSQLString.hpp"
            ...
            struct QueryHelper {
                ...
                inline static void deleteObj(SimpleOID const& oid, T* obj = nullptr) {
                    ...
                    try {
                        ...
                        blib::bun::__private::DbBackend<>::i().session() << sql, soci::use(oid_str);
                    }
                    catch (std::exception const & e) {
