...
namespace soci{
    ...
    struct type_conversion<edadb::SimpleObjHolder<T>> {
        ...
        inline static void from_base(soci::values const& v, soci::indicator ind, ObjectHolderType& obj_holder) { // in indicator out indicator -> enum i_ok i_null i_truncated
        ...
        /// @param soci::values& v
        /// @param soci::indicator& ind
        inline static void to_base(ObjectHolderType& obj_holder, soci::values& v, soci::indicator& ind) { //in out indicator
