...
for(auto i : obj->BOOST_PP_TUPLE_ELEM(BOOST_PP_ADD(0, n), ARRAY_FIELD_TUP)){\
    BOOST_PP_CAT(insertToDb_, BOOST_PP_TUPLE_ELEM(BOOST_PP_ADD(0, n), ARRAY_FIELD_TUP))(obj, &i);\
}
