      ...
      public:
        static std::string const& createTableStr() { // create_table_str
            ...
            if (sql.empty()) {
                ...
                sql += ", FOREIGN KEY (" + TypeMetaData<T>::class_name() + "_" + first_pair_T.second + ") REFERENCES " + TypeMetaData<T>::class_name() + "(" + first_pair_T.second + ") ON DELETE CASCADE ON UPDATE CASCADE";
                sql += ")";
            }
            return sql;
        }
...
template<typename T>
    ...
    template<typename T, typename Q>
    bool DbMapT2T<T,Q>::createTable(std::string tab_name){ // 这里tab_name不许空
    ...
    //     public:
    //         bool connectToDb(const std::string& db_connect_str){return true;}
    //         bool insertToDb(T *obj){}
    //         bool insertToDb(T *obj){return true;}
    //         // template <typename Q> bool insertToDb_idbsite_array(T *obj1, Q *obj2){return true;}
    //         // template <typename Q> bool insertToDb_array2_array(T *obj1, Q *obj2){return true;}
    //         bool insertToDbAll(T *obj){return true;}
    // };
...
template<typename myclass>\
    class DbMapAll{\ 
        ...
        public:\
            ...
            bool deleteFromDb_idbsite_array(myclass *obj1, IdbSite *obj2){\
                return dbmap_idbsite_array.deleteFromDb(obj1, obj2);\
            }\
            bool deleteFromDb_array2_array(myclass *obj1, Array2 *obj2){\
            ...
            bool updateDb_idbsite_array(myclass *obj1, IdbSite *obj2){\
                return dbmap_idbsite_array.updateDb(obj1, obj2);\
            }\
            bool updateDb_array2_array(myclass *obj1, Array2 *obj2){\
...
#define TABLE4CLASSWVEC(myclass, tablename, CLASS_ELEMS_TUP, ARRAY_FIELD_TUP) \
TABLE4CLASS(myclass, tablename, CLASS_ELEMS_TUP); \
