...
#include "lib/edadb/edadbTest21.hpp"
...
class IdbLayerShape {
  ...
  public:
    ...
    void print() const {
        std::cout << "LayerShape(name=" << _name 
                  << ", layer=" << _layer 
...
class IdbPort {
  public:
    std::string _name;
    IdbLayerShape _layer_shape_nor;
    IdbLayerShape* _layer_shape_ptr;
...
public:
    ...
    void print() const {
        ...
        _layer_shape_nor.print();
        _layer_shape_ptr->print();
    }
};
...
TABLE4CLASSWVEC(IdbLayerShape, "layer_shape_table", (_name, _layer, _rect_nor), (_rects, _rect2s));

TABLE4CLASSWVEC(IdbPort, "port_table", (_name, _layer_shape_nor, _layer_shape_ptr), (_layer_shapes, port_rects));
...
int main() {
  ...
  port._layer_shape_nor._name = "._layer_shape_nor__name";
  port._layer_shape_nor._layer = "._layer_shape_nor__layer";
  port._layer_shape_nor._rects.push_back(IdbRect(111));
  port._layer_shape_nor._rect2s.push_back(IdbRect2(222));
  port._layer_shape_nor._rect_nor.x = 333;
  IdbLayerShape layershape_ptr;
  layershape_ptr._name = "._layer_shape_ptr__name";
  layershape_ptr._layer = "._layer_shape_ptr__layer";
  layershape_ptr._rects.push_back(IdbRect(1111));
  layershape_ptr._rect_nor.x = 3333;
  port._layer_shape_ptr = &layershape_ptr;
